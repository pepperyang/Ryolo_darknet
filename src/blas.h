...
float dice_loss_cpu(int n, float* pred, float* truth, float* delta, float* error);//Syolo
void logistic_x_ent_cpu(int n, float* pred, float* truth, float* delta, float* error);//Syolo
